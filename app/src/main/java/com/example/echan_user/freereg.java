        ...
        dob.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               int month=calendar.get(Calendar.MONTH);
                ...
                DatePickerDialog dialog=new DatePickerDialog(freereg.this, android.R.style.Theme_Holo_Light_Dialog_MinWidth,mDateSetListener
                        ,year,month,day);
        ...
        rbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(!validateTitle() | !validatePassword1() | !validateNic() | !validateMobNo() | !validateLaName() |!validateFname() | !validateDob() | !validateCpassword() | !validateEmail()){
                    ...
                    Intent intent = new Intent(freereg.this , MainActivity.class);
